...
class StorageRuleAction(str, Enum):
    """Defines the available actions that can be triggered by storage rules."""
...
class RuleSideEffect:
    """Represents a side effect generated by a rule execution. This object encapsulates the necessary information to
    perform an action on the cache storage as a consequence of a rule match.

    Attributes:
        cache_key (str): The target key in the storage where the action applies.
        action (StorageRuleAction): The specific action to be performed (e.g., evict, set).
    """
